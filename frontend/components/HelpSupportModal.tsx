...
export function HelpSupportModal({ isOpen, onClose }: HelpSupportModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
            ...
            {/* Modal */}
            <div className="relative w-full max-w-lg bg-[#0F0F0F] border border-[#E5E5E5] rounded-md shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200">
                {/* Header */}
                ...
                <div className="p-6 max-h-[70vh] overflow-y-auto custom-scrollbar">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-8">
                        <button className="flex flex-col items-center justify-center p-4 rounded-md bg-[rgba(245,241,232,0.03)] border border-[#E5E5E5] hover:border-[#00D084] hover:bg-[rgba(0,208,132,0.05)] transition-all group">
                    ...
                    <div className="space-y-3">
                        {faqs.map((faq, index) => (
                            <div
                                key={index}
                                className="border border-[#E5E5E5] rounded-md overflow-hidden bg-[rgba(245,241,232,0.02)]"
                            >
                                <button
                    ...
                    {/* Contact Note */}
                    <div className="mt-8 p-4 rounded-md bg-[rgba(0,208,132,0.05)] border border-[rgba(0,208,132,0.1)] flex items-start gap-3">
