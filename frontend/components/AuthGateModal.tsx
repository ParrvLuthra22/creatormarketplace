        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white border border-[#E5E5E5] rounded-md w-full max-w-md shadow-2xl p-10 transform transition-all animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="text-center mb-8">
                    <div className="w-16 h-16 bg-[#FF4D00] hover:bg-[#FF4D00] rounded-full flex items-center justify-center mx-auto mb-4">
                        <svg className="w-8 h-8 text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                        </svg>
                    </div>

                    <h2 className="text-2xl font-bold text-black mb-2 font-milker">
