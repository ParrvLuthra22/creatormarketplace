...
import { Search, Bell, DollarSign, Mail, Eye, ArrowRight, FileText, User as UserIcon, CheckCircle } from "lucide-react";
                ...
                <main className="flex-1 overflow-y-auto px-4 md:px-7 py-6 md:py-8 pb-24 md:pb-8 md:ml-[220px]">
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-8 stat-cards-grid">
                        ...
                        <div className="bg-[#141414] border border-[#1F1F1F] rounded-[14px] p-5 relative stat-card">
                            ...
                            <p className="text-[10px] uppercase text-[#6B6B6B] font-angelo tracking-widest">PROFILE VIEWS</p>
                            <p className="text-[30px] text-white font-angelo mt-2">127</p>
